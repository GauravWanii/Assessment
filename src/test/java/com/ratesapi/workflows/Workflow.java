package com.ratesapi.workflows;

import io.restassured.response.Response;
import org.testng.Assert;

import com.ratesapi.configuration.RequestBase;
import com.ratesapi.constants.ProjectConstants;
import com.ratesapi.utils.CommonMethods;
...
public class Workflow extends RequestBase {
    ...
    public Workflow validateLatestRates() throws Exception {
        validateGeneralRates(ProjectConstants.LATESTDATE);
        return this;
    }
    ...
    public Workflow validateFutureRates() throws Exception {
        validateGeneralRates(ProjectConstants.FUTUREDATE);
        return this;
    }
    //endregion
    ...
    private void validateGeneralRates(String basePath) throws Exception {
        ...
        List<String> currencyCodes = CommonMethods.readSingleLineCSV(ProjectConstants.CURRENT_PATH +
                "/src/test/java/com/ratesapi/data/currency-codes.csv");
